App = {
    ...
    init: async function () {
        ...
        // $('#originFarmerID').val(ethereum.selectedAddress);
        // $('#distributorID').val(ethereum.selectedAddress);
        // $('#retailerID').val(ethereum.selectedAddress);
        // $('#consumerID').val(ethereum.selectedAddress);
        return result;
    },
